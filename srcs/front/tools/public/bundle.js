...
(() => {
    ...
    n = {
      ...
      551: (e, t, n) => {
        ...
        function $e(e, t, n, r, a, l, o, i, u) {
          ((Ie = !1), (Me = null), Fe.apply(Ae, arguments));
        }
        function Be(e) {
          var t = e,
            n = e;
          ...
          if (Vt) {
            ...
            if (null === a) (Vr(e, t, r, qt, n), Ft(e, r));
              ...
              for (; null !== a; ) {
                ...
                if (
                  (null !== l && xt(l),
                  null === (l = Kt(e, t, n, r)) && Vr(e, t, r, qt, n),
                  l === a)
                )
                  break;
                a = l;
        ...
        function Ba() {
          if (!Aa && null !== Da) {
            ...
            try {
              ...
              throw (null !== Da && (Da = Da.slice(e + 1)), Ge(Ze, Ba), t);
            } finally {
              ((bt = t), (Aa = !1));
            }
          }
        ...
        function Kl(e, t) {
          switch ((Na(Gl, t), Na(Ql, e), Na(Hl, Vl), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function ui(e, t, n, r) {
          ...
          ("object" == typeof l && null !== l
            ? (a.context = Ol(l))
            : ((l = La(t) ? Oa : Pa.current), (a.context = Ta(e, l))),
            ...
            case 6:
              if (e && null != t.stateNode) zi(e, t, e.memoizedProps, r);
                ...
                if ("string" != typeof r && null === t.stateNode)
                  throw Error(l(166));
                if (((n = ql(Gl.current)), ql(Hl.current), fl(t))) {
                  if (
                    ((r = t.stateNode),
                    (n = t.memoizedProps),
                    (r[da] = t),
              ...
              switch (((e.finishedWork = a), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ra(xs.bind(null, e, Au, Wu), t);
                    break;
                  }
                  xs(e, Au, Wu);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ra(xs.bind(null, e, Au, Wu), r);
                    break;
                  }
                  xs(e, Au, Wu);
                  break;
        ...
        function cs(e) {
          ...
          try {
            ...
            ((bt = r), (_u.transition = n), !(6 & (Pu = t)) && Ba());
          }
        }
        function fs() {
          ((Lu = Ru.current), Ca(Ru));
        ...
        function vs(e, t) {
          ...
          if ((Nl(), (Pu = n), (Cu.current = r), null !== Ou))
            throw Error(l(261));
        ...
        function ws(e) {
          ...
          do {
            ...
            } else if (null !== (n = Gi(n, t, Lu))) return void (Ou = n);
  ...
  function y(e, t, n) {
    return (
      void 0 === n && (n = "/"),
      (function (e, t, n, r) {
        let a = L(("string" == typeof t ? v(t) : t).pathname || "/", n);
    ...
    for (let e = 0; e < r.length; ++e) {
      ...
      (Object.assign(a, c.params),
        o.push({
          ...
          pathnameBase: M(I([l, c.pathnameBase])),
          route: f,
        }),
  ...
  const W = i.createContext(null),
    ...
    G = i.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
    q = i.createContext(null);
  function K() {
    return null != i.useContext(Q);
  }
  function Y() {
    return (K() || f(!1), i.useContext(Q).location);
  }
  function X(e) {
    i.useContext(H).static || i.useLayoutEffect(e);
  }
  function J() {
    let { isDataRoute: e } = i.useContext(G);
    return e
      ? (function () {
          let { router: e } = (function () {
              let e = i.useContext(W);
              return (e || f(!1), e);
            })(le.UseNavigateStable),
            t = ie(oe.UseNavigateStable),
            n = i.useRef(!1);
          return (
            X(() => {
              n.current = !0;
              ...
              function (r, a) {
                (void 0 === a && (a = {}),
                  n.current &&
                    ("number" == typeof r
                      ? e.navigate(r)
                      : e.navigate(r, B({ fromRouteId: t }, a))));
              },
              [e, t],
            )
          );
      ...
      : (function () {
          K() || f(!1);
          let e = i.useContext(W),
            { basename: t, future: n, navigator: r } = i.useContext(H),
            { matches: a } = i.useContext(G),
            { pathname: l } = Y(),
            o = JSON.stringify(z(a, n.v7_relativeSplatPath)),
            u = i.useRef(!1);
          return (
            X(() => {
              u.current = !0;
            ...
            i.useCallback(
              function (n, a) {
                ...
                let i = F(n, JSON.parse(o), l, "path" === a.relative);
                (null == e &&
                  "/" !== t &&
                  (i.pathname = "/" === i.pathname ? t : I([t, i.pathname])),
  ...
  function Z(e, t) {
    let { relative: n } = void 0 === t ? {} : t,
      { future: r } = i.useContext(H),
      { matches: a } = i.useContext(G),
      { pathname: l } = Y(),
      o = JSON.stringify(z(a, r.v7_relativeSplatPath));
    return i.useMemo(() => F(e, JSON.parse(o), l, "path" === n), [e, o, l, n]);
  }
  function ee(e, t, n, r) {
    K() || f(!1);
    let { navigator: a } = i.useContext(H),
      { matches: o } = i.useContext(G),
      u = o[o.length - 1],
      s = u ? u.params : {},
  ...
  const ne = i.createElement(te, null);
  ...
  function ae(e) {
    ...
    return (
      ...
      i.createElement(G.Provider, { value: t }, r)
    );
  }
  var le = (function (e) {
      return (
  ...
  function se(e) {
    ...
    K() || f(!1);
    let { future: l, static: o } = i.useContext(H),
      { matches: u } = i.useContext(G),
      { pathname: s } = Y(),
      c = J(),
      d = F(t, z(u, l.v7_relativeSplatPath), s, "path" === a),
      p = JSON.stringify(d);
    return (
      i.useEffect(
        () => c(JSON.parse(p), { replace: n, state: r, relative: a }),
        [c, p, a, n, r],
      ),
      null
    );
  ...
  function fe(e) {
    ...
    let c = t.replace(/^\/*/, "/"),
      d = i.useMemo(
        () => ({
          ...
          navigator: o,
          static: u,
          future: B({ v7_relativeSplatPath: !1 }, s),
        }),
        [c, s, o, u],
      );
    ...
    return null == b
      ...
      : i.createElement(
          H.Provider,
          { value: d },
          i.createElement(Q.Provider, { children: n, value: b }),
        );
  }
  function de(e) {
  ...
  function pe(e, t) {
    ...
    return (
      i.Children.forEach(e, (e, r) => {
        ...
        (e.props.children && (l.children = pe(e.props.children, a)), n.push(l));
      }),
      n
    );
  }
  function he() {
          ...
          (function (n, r, a) {
            var l,
              ...
              d = {
                ...
                f: p.bind(e, 4),
                d: function (t, n) {
                  return ((l = t), (i = 0), (u = e), (d.n = n), o);
                },
              };
            function p(n, r) {
              for (i = n, u = r, t = 0; !f && s && !a && t < c.length; t++) {
                var a,
                  l = c[t],
                  p = d.p,
                  h = l[2];
                n > 3
                  ? (a = h === r) &&
                    ((u = l[(i = l[4]) ? 5 : ((i = 3), 3)]), (l[4] = l[5] = e))
                  : l[0] <= p &&
                    ((a = n < 2 && p < l[1])
                      ? ((i = 0), (d.v = r), (d.n = l[1]))
                      : p < h &&
                        (a = n < 3 || l[0] > r || r > h) &&
                        ((l[4] = n), (l[5] = r), (d.n = h), (i = 0)));
              }
              if (a || n > 1) return o;
              throw ((f = !0), r);
            }
                    ...
                    if ((i || (a = "next"), (t = l[a]))) {
                      ...
                      (1 === i && (t = l.return) && t.call(l),
                        i < 2 &&
                          ...
                          (i = 1)));
                    l = e;
                  } else if ((t = (f = d.n < 0) ? u : n.call(r, d)) !== o)
                    break;
                } catch (t) {
                  ((l = e), (i = 1), (u = t));
                } finally {
    ...
    var c = [][r]
        ...
        : (me((t = {}), r, function () {
          ...
          t),
      f = (s.prototype = i.prototype = Object.create(c));
    function d(e) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(e, s)
          : ((e.__proto__ = s), me(e, a, "GeneratorFunction")),
  ...
  (u.startTransition, new Promise(() => {}), i.Component);
  var ve = {
    LogLevel: { INFO: !0, WARN: !0, ERROR: !0, DEBUG: !0 },
              ...
              for (;;)
                switch ((e.p = e.n)) {
                  ...
                  case 3:
                    return (
                      (n = e.v),
                      console.log("Auth check response data:", n),
                      e.a(2, n)
                    );
                  case 4:
                    return (
                      ...
                      (r = e.v),
                      ve.LogLevel.ERROR &&
                        console.error("Auth check error:", r),
                      e.a(2, {
                        isAuthenticated: !1,
  ...
  const ge = a.p + "6655dd549fe4f1218d9a2a7c01b99552.png";
  var ye = function (e, t) {
    var n = {};
    for (var r in e)
  ...
  function xe() {
    var e = function (e) {
      (sessionStorage.setItem("auth_provider", e),
        (window.location.href = "http://localhost:3000/api/v1/auth/".concat(
          e,
        )));
    };
    return (0, o.jsxs)("div", {
      className: "mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 font-secondary",
      children: [
        (0, o.jsxs)("button", {
          type: "button",
          onClick: e.bind(null, "google"),
          className:
            "flex items-center justify-center gap-3 w-full rounded-lg border border-gray-700 bg-secondary-btn py-3 text-md font-medium hover:bg-white/10 transition duration-500",
          children: [
            (0, o.jsx)("span", {
              className:
                "h-5 w-5 rounded-sm bg-white/20 flex items-center justify-center text-xs",
              children: "G",
            }),
            (0, o.jsx)("span", { children: "Continue with Google" }),
          ],
        }),
        (0, o.jsxs)("button", {
          type: "button",
          onClick: e.bind(null, "42intra"),
          className:
            "flex items-center justify-center gap-3 w-full rounded-lg border border-gray-700 bg-secondary-btn py-3 text-md font-medium hover:bg-white/10 transition duration-500",
          children: [
            (0, o.jsx)("span", {
              className:
                "h-5 w-5 rounded-sm bg-white/20 flex items-center justify-center text-[10px] font-bold",
              children: "42",
            }),
            (0, o.jsx)("span", { children: "Continue with 42" }),
          ],
        }),
      ],
    });
  }
  const ke = a.p + "85129c90476ed026f388c41d6704162a.png";
  function Se(e) {
    var t = e.children;
    return (0, o.jsxs)("div", {
      className: "background-auth",
      style: { backgroundImage: "url(".concat(ke, ")") },
      children: [
        (0, o.jsx)("img", {
          src: ke,
        ...
        (0, o.jsx)("div", { className: "absolute inset-0 bg-black/60 z-0" }),
        (0, o.jsx)("div", {
          className: "auth-elements-container font-primary relative z-10",
          children: t,
        }),
      ],
    });
  ...
  function Ee(e) {
    ...
    return (0, o.jsx)("div", {
      ...
      children: (0, o.jsx)("input", {
        ...
        required: a,
        className:
          "w-full rounded-lg border border-gray-700 bg-primary-bg py-3 px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400",
      }),
    });
  }
  function Ce() {
    ...
    function d(e) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(e, s)
          : ((e.__proto__ = s), Ne(e, a, "GeneratorFunction")),
        (e.prototype = Object.create(f)),
        e
      );
    }
    return (
      ...
      Ne(s, "constructor", u),
      (u.displayName = "GeneratorFunction"),
      Ne(s, a, "GeneratorFunction"),
      Ne(f),
      Ne(f, a, "Generator"),
      Ne(f, r, function () {
        return this;
      }),
      Ne(f, "toString", function () {
        return "[object Generator]";
      }),
      (Ce = function () {
        return { w: l, m: d };
  ...
  function Oe() {
    var e = this,
      ...
      r = n[0],
      a = n[1],
      l = Pe((0, i.useState)(!1), 2),
      u = l[0],
      s = l[1],
      c = Pe((0, i.useState)(!1), 2),
      f = c[0],
      d = c[1],
      p = Pe((0, i.useState)("Create Account"), 2),
      h = p[0],
      m = p[1];
    return (
      (0, i.useEffect)(
      ...
      (0, o.jsxs)(Se, {
        children: [
          (0, o.jsxs)("div", {
            ...
            children: [
              ...
              (0, o.jsx)("p", {
                ...
                children: "Join, track stats, and compete on the leaderboard",
              }),
            ],
          }),
          (0, o.jsx)("div", {
            ...
            children: (0, o.jsxs)("button", {
              ...
              className:
                "text-md text-gray-300 hover:text-white transition-colors",
              children: [
                "← Back to ",
                (0, o.jsx)("span", {
          ...
          (0, o.jsxs)("form", {
            onSubmit: function (t) {
              return (
                ...
                (l = void 0),
                (o = Ce().m(function e() {
                  var n, r, l, o, i, u, c, f, p, h, v, g, y, b, w;
                  return Ce().w(
                    function (e) {
                      for (;;)
                        switch ((e.p = e.n)) {
                          case 0:
                            if (
                              ...
                              (u = t.currentTarget),
                              (c =
                                null === (n = u.elements.namedItem("email")) ||
                                void 0 === n
                                  ? void 0
                                  : n.value),
                              (f =
                                null === (r = u.elements.namedItem("first")) ||
                                void 0 === r
                                  ? void 0
                                  : r.value),
                              (p =
                                null === (l = u.elements.namedItem("last")) ||
                                void 0 === l
                                  ? void 0
                                  : l.value),
                              (h =
                                null ===
                                  (o = u.elements.namedItem("password")) ||
                                void 0 === o
                                  ? void 0
                                  : o.value),
                              /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{6,}$/.test(h))
                          ...
                          case 4:
                            return (
                              ...
                              (b = e.v),
                              ve.LogLevel.ERROR &&
                                console.error("SignUp network error:", b),
                              (v =
                                b && "object" === _e(b) && "message" in b
                                  ? b.message
                                  : String(b)),
                              a("Network error: ".concat(v)),
                              m("Create Account"),
                              d(!1),
                              e.a(2)
                            );
                          case 5:
                            if (
                              (ve.LogLevel.DEBUG &&
                                console.log("SignUp Response status:", i),
                              (g = i.headers.get("content-type")),
                              (y = {}),
                              !g || !g.includes("application/json"))
                            ) {
                              e.n = 7;
                              break;
                            }
                          ...
                          case 12:
                            (ve.LogLevel.ERROR &&
                              ...
                              a(
                                "Unexpected error occurred (".concat(
                                  i.status,
                                  "). Please try again.",
                                ),
                              ),
            ...
            children: [
              ...
              (0, o.jsx)(be, {
                ...
                props: {
                  ...
                  disabled: f,
                  className:
                    "w-full rounded-lg bg-cyan-500 hover:bg-cyan-600 active:bg-primary-btn transition-colors duration-300 text-secondary-text py-3 font-bold shadow-md ".concat(
              ...
              r &&
                (0, o.jsx)("p", {
                  className: "text-center font-fontFamily-secondary ".concat(
                    r.includes("success")
          ...
          (0, o.jsx)("div", {
            className: "mt-6 text-center text-md text-gray-300",
            children: (0, o.jsxs)("button", {
              onClick: function () {
                return t("/sign-in/");
              },
          ...
          (0, o.jsx)("div", {
            className: "text-center mb-4 mt-6 font-secondary text-gray-300",
            children: (0, o.jsx)("p", {
              className: "text-md",
  ...
  function Ie(e) {
    ...
    null == o.current &&
      (o.current =
        ...
        (function (e, t, n, r) {
          ...
          null == v &&
            ((v = 0), i.replaceState(s({}, i.state, { idx: v }), ""));
          let w = {
            get action() {
              return u;
            },
    ...
    let d = o.current,
      [v, g] = i.useState({ action: d.action, location: d.location }),
    ...
    return (
      i.useLayoutEffect(() => d.listen(b), [d, b]),
      i.useEffect(() => {
        return (
  ...
  const Me =
    ...
    Ue = i.forwardRef(function (e, t) {
      let n,
        ...
        { basename: v } = i.useContext(H),
        g = !1;
      if ("string" == typeof c && De.test(c) && ((n = c), Me))
        try {
      ...
      let y = (function (e, t) {
          let { relative: n } = void 0 === t ? {} : t;
          K() || f(!1);
          let { basename: r, navigator: a } = i.useContext(H),
            { hash: l, pathname: o, search: u } = Z(e, { relative: n }),
            s = o;
          return (
            "/" !== r && (s = "/" === o ? r : I([r, o])),
  ...
  function Be() {
    ...
    function d(e) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(e, s)
          : ((e.__proto__ = s), We(e, a, "GeneratorFunction")),
        (e.prototype = Object.create(f)),
        e
      );
    }
    return (
      ...
      We(s, "constructor", u),
      (u.displayName = "GeneratorFunction"),
      We(s, a, "GeneratorFunction"),
      We(f),
      We(f, a, "Generator"),
      We(f, r, function () {
        return this;
      }),
      We(f, "toString", function () {
        return "[object Generator]";
      }),
      (Be = function () {
        return { w: l, m: d };
  ...
  function Qe() {
    var e = this,
      t = J(),
      n = Ve((0, i.useState)(!1), 2),
      r = n[0],
      a = n[1],
      l = Ve((0, i.useState)("Sign In"), 2),
      u = l[0],
      s = l[1],
      c = Ve((0, i.useState)(""), 2),
      f = c[0],
    ...
    return (0, o.jsxs)(Se, {
      children: [
                      ...
                      case 0:
                        (t.preventDefault(),
                          ...
                          setTimeout(function () {
                            (a(!1),
                              s("Sign In"),
                              d("Sign-in functionality not implemented yet"));
                          }, 2e3));
                      case 1:
                        return e.a(2);
                    }
        ...
        (0, o.jsx)("div", {
          className: "text-center mb-4 mt-6 text-gray-300",
          children: (0, o.jsx)("p", {
            className: "text-md",
            children: "Sign in with others",
          }),
        }),
        (0, o.jsx)(xe, {}),
        (0, o.jsx)("div", {
          className: "text-center mt-6 font-primary text-gray-300",
  ...
  function Ge() {
    ...
    function d(e) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(e, s)
          : ((e.__proto__ = s), qe(e, a, "GeneratorFunction")),
        (e.prototype = Object.create(f)),
        e
      );
    }
  ...
  function Xe(e) {
    var t = this,
      n = e.children,
      r = e.redirectTo,
      a = void 0 === r ? "/dashboard" : r,
      l = Ke((0, i.useState)(!0), 2),
      u = l[0],
      s = l[1],
      c = Ke((0, i.useState)(!1), 2),
      f = c[0],
      d = c[1],
      p = J();
    return (
              ...
              return Ge().w(
                function (e) {
                  for (;;)
                    switch ((e.p = e.n)) {
                      case 0:
                        return ((e.p = 0), (e.n = 1), ve.checkAuthCookie());
                      case 1:
                        (e.v.isAuthenticated
                          ? (d(!0), p(a, { replace: !0 }))
                          : d(!1),
                      ...
                      case 2:
                        ((e.p = 2),
                          (t = e.v),
                          ve.LogLevel.ERROR &&
                            console.error("AuthGuard error:", t),
                          d(!1));
                      case 3:
                        return ((e.p = 3), s(!1), e.f(3));
                      case 4:
                        return e.a(2);
                    }
                },
      ...
      u
        ? (0, o.jsx)("div", {
            className:
              "min-h-screen bg-primary-bg flex items-center justify-center",
            children: (0, o.jsxs)("div", {
              className: "text-center",
              children: [
                (0, o.jsx)("div", {
                  className:
                    "animate-spin rounded-full h-12 w-12 border-b-2 border-cyan-400 mx-auto mb-4",
                }),
                (0, o.jsx)("p", {
  ...
  function Je() {
    ...
    function d(e) {
      return (
        Object.setPrototypeOf
          ? Object.setPrototypeOf(e, s)
          : ((e.__proto__ = s), Ze(e, a, "GeneratorFunction")),
        (e.prototype = Object.create(f)),
        e
      );
    }
    return (
      ...
      Ze(s, "constructor", u),
      (u.displayName = "GeneratorFunction"),
      Ze(s, a, "GeneratorFunction"),
      Ze(f),
      Ze(f, a, "Generator"),
      Ze(f, r, function () {
        return this;
      }),
      Ze(f, "toString", function () {
        return "[object Generator]";
      }),
      (Je = function () {
        return { w: l, m: d };
  ...
  function rt() {
    var e = this,
      t = J(),
      n = et((0, i.useState)(null), 2),
      r = n[0],
      a = n[1],
      l = et((0, i.useState)(!0), 2),
      u = l[0],
      s = l[1];
    return (
      (0, i.useEffect)(
                    ...
                    switch ((e.p = e.n)) {
                      ...
                      case 2:
                        ((e.p = 2),
                          (r = e.v),
                          ve.LogLevel.ERROR &&
                            console.error("Dashboard auth check error:", r),
                          t("/", { replace: !0 }));
                      case 3:
                        return ((e.p = 3), s(!1), e.f(3));
                      case 4:
                    ...
                    (0, o.jsxs)("div", {
                      children: [
                        ...
                        (0, o.jsxs)("p", {
                          ...
                          children: [
                            "Welcome back, ",
                            null == r ? void 0 : r.firstName,
                            " ",
                            null == r ? void 0 : r.lastName,
                            "!",
                          ],
                        }),
                      ],
                      ...
                      children: [
                        ...
                        (0, o.jsxs)("div", {
                          ...
                          children: [
                            (0, o.jsx)("button", {
                              className:
                                "w-full bg-cyan-600 hover:bg-cyan-700 text-white py-2 px-4 rounded-lg transition-colors",
  ...
  function at() {
    ...
    return (0, o.jsxs)("div", {
      ...
      children: [
        ...
        (0, o.jsx)("div", { className: "absolute inset-0 bg-black/45 z-0" }),
        (0, o.jsxs)("div", {
          className:
            "relative z-10 flex flex-col items-center text-center mx-auto",
          children: [
            (0, o.jsx)("img", {
              src: ge,
              alt: "Logo",
              className:
                "w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mb-10 // Increased spacing for visual break",
            }),
            (0, o.jsxs)("h1", {
              className:
                "// Text size and font weight for high impact text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-primary font-extrabold leading-none mb-4 text-shadow-md",
              children: [
                "Ready to Play?",
                (0, o.jsxs)("span", {
                  className: "text-white drop-shadow-lg font-primary",
                  children: [(0, o.jsx)("br", {}), "it's Your Serve"],
                }),
              ],
            }),
            (0, o.jsx)("p", {
              className:
                "text-sm sm:text-base md:text-lg text-gray-300 font-light mb-12 // Increased spacing before buttons font-secondary underline",
              children:
                "Track stats, connect with friends, and dominate the leaderboard",
            }),
            (0, o.jsxs)("div", {
              className:
                "flex flex-col w-full max-w-sm space-y-4 justify-center",
              children: [
                (0, o.jsx)(we, {
                  func: function () {
                    return e("/sign-up/");
  ...
  function lt() {
    return (0, o.jsxs)(de, {
      children: [
        (0, o.jsx)(ce, {
          path: "/",
          element: (0, o.jsx)(Xe, { children: (0, o.jsx)(at, {}) }),
        }),
        (0, o.jsx)(ce, {
          path: "/public/",
          element: (0, o.jsx)(Xe, { children: (0, o.jsx)(at, {}) }),
        ...
        (0, o.jsx)(ce, {
          path: "/sign-up/",
          element: (0, o.jsx)(Xe, { children: (0, o.jsx)(Oe, {}) }),
        }),
        (0, o.jsx)(ce, {
          path: "/sign-in/",
          element: (0, o.jsx)(Xe, { children: (0, o.jsx)(Qe, {}) }),
        }),
        (0, o.jsx)(ce, { path: "/dashboard", element: (0, o.jsx)(rt, {}) }),
        (0, o.jsx)(ce, {
          path: "*",
          element: (0, o.jsx)(se, { to: "/", replace: !0 }),
        }),
      ],
    });
  }
