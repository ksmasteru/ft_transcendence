...
export const createNotification = async ({ userId, type, title, message, avatar, actionable = false, metadata = null }) => {
  try {
    return await prisma.notification.create({
      data: { userId, type, title, message, avatar: avatar || null, actionable, metadata },
    });
  } catch (e) {
